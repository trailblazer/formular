  ...
  describe Formular::Builders::Bootstrap3 do
    ...
    describe 'returns html correctly' do
      it '#outputs with block' do
        ...
        form.to_s.must_equal %(<form method="post" accept-charset=\"utf-8\" action="/questions/13"><input name=\"utf8\" type=\"hidden\" value=\"✓\"/><div class="form-group"><label for="comment_body" class="control-label">Body</label><input name="comment[body]" id="comment_body" value="Something exciting" type="text" class="form-control"/></div></form>)
      end
    ...
    it 'file field has correct class' do
      ...
      form.to_s.must_equal %(<form method="post" accept-charset=\"utf-8\" action="/questions/13"><input name=\"utf8\" type=\"hidden\" value=\"✓\"/><div class="form-group"><label for="comment_body" class="control-label">Body</label><input name="comment[body]" id="comment_body" value="Something exciting" type="file"/></div></form>)
    end
  end
