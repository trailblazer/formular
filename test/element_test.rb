...
describe Formular::Element do
  ...
  describe "#normalize_attributes" do
    class CorrectAttrsInput < Formular::Element
      tag 'input'
      add_option_keys :option_1, :option_2, :option_3
    ...
    it "should exclude nil keys" do
      element.options.must_equal(option_2: 'an option')
    end
    ...
    it "should allow defaults to be overriden" do
      ...
      element.attributes.must_equal(class: ['another-class', 'some-class'], value: 'some value')
      element.options.must_equal(option_1: "I don't care if you're happy!")
    end
  end
